  ...
  <footer className="footer">
    <div className="footer-content">
      ...
      <div className="footer-center">
        <a href="#" className="footer-icon" title="GitHub" target="_blank" rel="noopener noreferrer">
          {/* GitHub SVG */}
        ...
        <a href="#" className="footer-icon" title="LinkedIn" target="_blank" rel="noopener noreferrer">
          {/* LinkedIn SVG */}
